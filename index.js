  ...
  document.querySelector('#root').innerHTML = `
    <div class="app-shell">
      <header class="topbar">
        ...
        <div class="network-chip"><span class="pulse"></span> Studionet <small>5 validators</small></div><a class="contract-chip" href="${CONTRACT_URL}" target="_blank" rel="noreferrer"><span class="contract-dot">${icon('link',12)}</span> <span>Contract</span> <code>0x6039…A867</code>${icon('external',12)}</a>
      </header>
